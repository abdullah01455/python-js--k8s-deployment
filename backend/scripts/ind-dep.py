...
def create_deployment():
    ...
    metadata = client.V1ObjectMeta(name="indvisuals-deployment")

    # Define the selector for the Deployment
    selector = client.V1LabelSelector(match_labels={"app": "indvisuals"})

    # Define the labels for the Deployment's template
    labels = {"app": "indvisuals"}

    # Define the container spec for the Deployment
    container = client.V1Container(
        name="indvisuals-container",
        image="hub.leandevclan.com/indvisuals:latest",
