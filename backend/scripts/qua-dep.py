...
def create_deployment():
    ...
    metadata = client.V1ObjectMeta(name="quarantine-deployment")

    # Define the selector for the Deployment
    selector = client.V1LabelSelector(match_labels={"app": "quarantine"})

    # Define the labels for the Deployment's template
    labels = {"app": "quarantine"}

    # Define the container spec for the Deployment
    container = client.V1Container(
        name="quarantine-container",
        image="hub.leandevclan.com/quarantine:latest",
